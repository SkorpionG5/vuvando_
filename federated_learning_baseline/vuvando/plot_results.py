...
def plot_results(rounds, train_losses, eval_losses):
    ...
    plt.title('Federated Anomaly Detection: Baseline (FedAvg)', fontsize=14)
    ...
    print("Graph saved as 'baseline_results.png'")
    # plt.show() # Uncomment if you have a GUI

if __name__ == "__main__":
    rounds, t_loss, e_loss = parse_log('log_baseline.txt')
